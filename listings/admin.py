...
class ListingAdminForm(forms.ModelForm):
    professions = forms.ModelMultipleChoiceField(queryset=Subject.objects.all(), widget=FilteredSelectMultiple(verbose_name="professions", is_stacked=False, attrs={'rows':5}), required=False, label="Select Professions")
    class Meta:
        model = Listing
        fields = '__all__'
        widgets = {
